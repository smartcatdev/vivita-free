<div class="vivita-contact-form <?php echo isset( $instance['scmod_contact_form_width'] ) ? 'col-sm-' . $instance['scmod_contact_form_width'] : 'col-sm-12'; ?>">
    ...
    <form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" id="scmod-contact-form">
        ...
        <div class="mail-sent"><span class="fa fa-check-circle"></span> <?php _e( 'Email sent!', 'vivita' ); ?></div>
        <div class="mail-not-sent"><span class="fa fa-exclamation-circle"></span> <?php _e( 'There has been an error, please check the information you entered and try again.', 'vivita' ); ?></div>
