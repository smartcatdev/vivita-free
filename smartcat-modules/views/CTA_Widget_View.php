<div class="vivita-callout <?php echo isset( $instance['scmod_cta_widget_width'] ) ? 'col-sm-' . $instance['scmod_cta_widget_width'] : 'col-sm-12'; ?>">
    ...
    <div class="buttons">
        ...
        <?php if( !empty( $instance['scmod_cta_btn_1_text'] ) ) : ?>
            <a class="accent-button" href="<?php echo esc_url( $instance['scmod_cta_btn_1_url'] ); ?>">
                <?php echo esc_html( $instance['scmod_cta_btn_1_text'] ); ?>
            </a>
        <?php endif; ?>
            
        <?php if( !empty( $instance['scmod_cta_btn_2_text'] ) ) : ?>
            <a class="accent-button" href="<?php echo esc_url( $instance['scmod_cta_btn_2_url'] ); ?>">
